...
guestList.forEach(guestList => {
   console.log(`Hello ${guestList} will you attend the dinner with me?`);
...
while(guestList.length >2) {
   let remeoveGuests = guestList.pop()
   console.log(`sorry, ${remeoveGuests} You are not invited for dinner.`);
   
}

guestList.forEach(guestList => {
   console.log(`${guestList} You are invited for the dinner.`);
...
let bucketListPlaces=["Makkah","Medina","Karbala","Dubai","Germany","Pakistan"]
